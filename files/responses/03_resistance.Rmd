...
Length: 3-4 pages, 12 point font, double spaced. 
...
2. Your long response should include the following sections:
    ...
    * **Overview of algorithm (3 points):** What, if any, algorithms are involved? Why do these satisfy the definition of algorithm? What are the inputs and outputs?
    ...
    * **Ethical issues (3 points):** Identify potential ethical concerns related to your decision system. For each ethical concern raised, be sure to identify potential remedies if there are any.
